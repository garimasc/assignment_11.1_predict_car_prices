...
<center><img src="images/hist_price.png" alt="histogram_prices" width="400"/></center>
...
<center><img src="images/px_year_odometer.png" alt="year_odometer" width="550"/></center>
...
<center><img src="images/px_fuel_condition_drive.png" alt="other_features" height="150"/></center>
...
<center><img src="images/pipe_process.png" alt="processing" height="200"></center>
...
We build a few different kinds of models, based on simple averages, target-encoding for model and manufacturer, and LASSO and RFE. For the latter two, we use 5-fold cross-validation to choose the hyperparameters. The lowest test RMSE is around $7000, using both RFE and LASSO.
 ...
 <center><img src="images/evaluation_rmse.png" alt="processing" height="150"></center>
...
**Two identical 2020 Chevroler Silverado 1500 have a price differential of $18k with a change in odometer reading**
  <center><img src="images/chevrolet.png" alt="chevrolet" height="45"></center>
